package com.gollum.atlanteanmillenaire.client.model.sofa;
...
public class ModelSofaLeft extends ModelBase implements JFIModel {
	...
	ModelRenderer foot1;
	ModelRenderer foot2;
	ModelRenderer fushion;

	public ModelSofaLeft() {
		...
		this.fushion = new ModelRenderer(this, 67, 35);
		this.fushion.addBox(0.0F, 0.0F, 0.0F, 14, 3, 14);
		this.fushion.setRotationPoint(-6.0F, 16.0F, -7.5F);
		this.fushion.setTextureSize(128, 64);
		this.fushion.mirror = true;
		this.setRotation(this.fushion, 0.0F, 0.0F, 0.0F);
	}
